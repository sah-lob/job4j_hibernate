...
public class DBCarStoreController implements CarStoreController {
    ...
    private  final static DBCarStoreController DB_CAR_STORE_CONTROLLER = new DBCarStoreController();
    public static DBCarStoreController getInstance() {
        return DB_CAR_STORE_CONTROLLER;
    }

    private BrandStore brandStore = DBBrandStore.getInstance();
    private CarsStore carsStore = DBCarsStore.getInstance();
    private ImageStore imageStore = DBImageStore.getInstance();
    private UsersStore usersStore = DBUsersStore.getInstance();
